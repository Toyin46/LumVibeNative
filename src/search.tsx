// src/search.tsx - PRODUCTION SEARCH SCREEN
//
// ✅ CRITICAL FIX: `useNavigation()` was called at MODULE scope — same
//    class of bug as signup.tsx/themes.tsx. Moved inside SearchScreen().
// ✅ Removed unused `import { router } from 'expo-router'`.
// ✅ Fixed navigate paths: '/(tabs)/profile' → 'Main'+'Profile' tab,
//    '/user/${id}' → 'UserProfile'+{userId}, './post/${id}' → 'PostDetail'+{postId}.
...
const s = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#111', marginHorizontal: 20, marginBottom: 15, paddingHorizontal: 15, borderRadius: 12, borderWidth: 1, borderColor: '#222' },
  searchInput: { flex: 1, color: '#fff', fontSize: 16, paddingVertical: 12, marginLeft: 10 },
  ...
  userItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#111' },
  ...
  username: { color: '#999', fontSize: 14, marginTop: 2 },
  premiumBadge: { fontSize: 14 },
  postItem: { flexDirection: 'row', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#111' },
  postThumbnail: { width: 80, height: 80, borderRadius: 8, marginRight: 12 },
  postInfo: { flex: 1, justifyContent: 'space-between' },
  postCaption: { color: '#fff', fontSize: 14, marginBottom: 8 },
  postStats: { flexDirection: 'row', gap: 15 },
  statItem: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  statText: { color: '#999', fontSize: 12 },
