...
object EffectRequirements {
    ...
    // THERMAL_PULSE moved here (was a plain audioScoreEffect only)  -  its
    // shader now uses the real segmentation mask instead of a crude RGB
    // "isSkin()" guess (see EffectShaders.thermalPulse's doc for why that
