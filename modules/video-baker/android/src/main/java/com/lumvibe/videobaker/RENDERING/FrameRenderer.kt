...
class FrameRenderer {
    ...
    fun drawEffectFrame(textureId: Int, texMatrix: FloatArray, elapsedSec: Float) {
        ...
        val uParticleColorIdx = GLES20.glGetUniformLocation(program, "uParticleColorIdx")
        ...
        if (uParticleColorIdx >= 0) GLES20.glUniform1fv(uParticleColorIdx, 24, particleColorIndices, 0)
